...
const src = 'C:\\Users\\Ben19\\Downloads\\ChatGPT Image Jul 18, 2026, 06_24_25 PM.png';
...
await sharp(src)
  ...
  .toFile('public/team/amauris.jpg');
console.log('wrote public/team/amauris.jpg from', meta.width + 'x' + meta.height);
